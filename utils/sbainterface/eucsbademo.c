...
void sba_driver_interface(double** incams, double** inpts, double** outcams, double** outpts)
{
    void (*caminfilter)(double *pin, int nin, double *pout, int nout)=quat2vec;
    void (*camoutfilter)(double *pin, int nin, double *pout, int nout)=vec2quat;
