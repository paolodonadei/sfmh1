...
#define FULLQUATSZ     4
 ...
 void printSBAMotionData(FILE *fp, double *motstruct, int ncams, int cnp,void (*outfilter)(double *pin, int nin, double *pout, int nout), int cnop);
 void printSBAStructureData(FILE *fp, double *motstruct, int ncams, int n3Dpts, int cnp, int pnp);
 void printSBAData(FILE *fp, double *motstruct, int cnp, int pnp, int mnp, void (*outfilter)(double *pin, int nin, double *pout, int nout), int cnop, int ncams, int n3Dpts, double *imgpts, int n2Dprojs, char *vmask);
