function [MER, f1,f2,r,e2 ,w2] = HoumanminimalTwoFrameSolverdebug( F,w,h,f1guess,f2guess)
...
while count<100
    ...
    if(size(MS,2)==0)
        ...
        MER=calcMerror( M,P_in );
       % disp(['the error is ' num2str(MER)]);
