function [ A,b ] = formAunknownFLarge_selfcalib5( P )
...
for i=1:numFrames
    ...
    b(((i-1)*numRowsperFrame)+3,1)=1;
    
    A(((i-1)*numRowsperFrame)+j,1) = m(1,1) ^ 2;
    A(((i-1)*numRowsperFrame)+j,2) = 2 * m(1,1) * m(1,2);
    A(((i-1)*numRowsperFrame)+j,3) = 2 * m(1,1) * m(1,3);
    A(((i-1)*numRowsperFrame)+j,4) = 2 * m(1,1) * m(1,4);
    A(((i-1)*numRowsperFrame)+j,5) = m(1,2) ^ 2;
    A(((i-1)*numRowsperFrame)+j,6) = 2 * m(1,2) * m(1,3);
    A(((i-1)*numRowsperFrame)+j,7) = 2 * m(1,2) * m(1,4);
    A(((i-1)*numRowsperFrame)+j,8) = m(1,3) ^ 2;
    A(((i-1)*numRowsperFrame)+j,9) = 2 * m(1,3) * m(1,4);
    A(((i-1)*numRowsperFrame)+j,10) = m(1,4) ^ 2;
    
    j=j+1;
    
    A(((i-1)*numRowsperFrame)+j,1) = m(2,1) ^ 2;
    A(((i-1)*numRowsperFrame)+j,2) = 2 * m(2,1) * m(2,2);
    A(((i-1)*numRowsperFrame)+j,3) = 2 * m(2,1) * m(2,3);
    A(((i-1)*numRowsperFrame)+j,4) = 2 * m(2,1) * m(2,4);
    A(((i-1)*numRowsperFrame)+j,5) = m(2,2) ^ 2;
    A(((i-1)*numRowsperFrame)+j,6) = 2 * m(2,2) * m(2,3);
    A(((i-1)*numRowsperFrame)+j,7) = 2 * m(2,2) * m(2,4);
    A(((i-1)*numRowsperFrame)+j,8) = m(2,3) ^ 2;
    A(((i-1)*numRowsperFrame)+j,9) = 2 * m(2,3) * m(2,4);
    A(((i-1)*numRowsperFrame)+j,10) = m(2,4) ^ 2;
    
    j=j+1;
    
    A(((i-1)*numRowsperFrame)+j,1) = m(3,1) ^ 2;
    A(((i-1)*numRowsperFrame)+j,2) = 2 * m(3,1) * m(3,2);
    A(((i-1)*numRowsperFrame)+j,3) = 2 * m(3,1) * m(3,3);
    A(((i-1)*numRowsperFrame)+j,4) = 2 * m(3,1) * m(3,4);
    A(((i-1)*numRowsperFrame)+j,5) = m(3,2) ^ 2;
    A(((i-1)*numRowsperFrame)+j,6) = 2 * m(3,2) * m(3,3);
    A(((i-1)*numRowsperFrame)+j,7) = 2 * m(3,2) * m(3,4);
    A(((i-1)*numRowsperFrame)+j,8) = m(3,3) ^ 2;
    A(((i-1)*numRowsperFrame)+j,9) = 2 * m(3,3) * m(3,4);
    A(((i-1)*numRowsperFrame)+j,10) = m(3,4) ^ 2;
    ...
    A(((i-1)*numRowsperFrame)+j,4) = m(3,4) * m(1,1) + m(3,1) * m(1,4);
    ...
    A(((i-1)*numRowsperFrame)+j,9) = m(3,3) * m(1,4) + m(3,4) * m(1,3);
