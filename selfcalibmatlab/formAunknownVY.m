...
for i=1:numFrames
    ...
    A(((i-1)*numRowsperFrame)+4,4) = 2 * m(3,1) * m(1,4) + 2 * m(3,4) * m(1,1);
    A(((i-1)*numRowsperFrame)+4,5) = 2 * m(3,2) * m(1,2);
    A(((i-1)*numRowsperFrame)+4,6) = 2 * m(3,3) * m(1,2) + 2 * m(3,2) * m(1,3);
    A(((i-1)*numRowsperFrame)+4,7) = 2 * m(3,4) * m(1,2) + 2 * m(3,2) * m(1,4);
    A(((i-1)*numRowsperFrame)+4,8) = 2 * m(3,3) * m(1,3);
    A(((i-1)*numRowsperFrame)+4,9) = 2 * m(3,4) * m(1,3) + 2 * m(3,3) * m(1,4);
    A(((i-1)*numRowsperFrame)+4,10) = 2 * m(3,4) * m(1,4);
