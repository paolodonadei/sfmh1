...
function [F, iters, initPvi,h] = fundmatrixrobustcookupdateuplev(x1, x2)
...
updatepviFunc = @cookUpdatelevup;


% x1 and x2 are 'stacked' to create a 6xN array for ransac
[F, inliers,iters] = ransac([x1; x2], fittingfn, distfn, degenfn, s, t,scorefunc,randSampFunc,initPvi,updatepviFunc);
