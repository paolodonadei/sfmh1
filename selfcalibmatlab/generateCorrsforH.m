function [ Hgt,k1,k2,corrs,corrsclean, inlierOutlier, I1, I2,  R1, t1,R2,t2 ] = generateCorrsforH(numcorrs, outlierratio, stderror, type, seqname )
...
dirnames{2,1}='C:\Documents and Settings\hrast019\Desktop\data\euclidean\homography\';
dirnames{3,1}='E:\Documents and Settings\houman\Desktop\data\euclidean\homography\';
...
%     end
    ...
    partTwo=[' -N ' num2str(numcorrs) ' -E ' num2str(outlierratio) ' -v ' num2str(stderror) ' -T 3 -q 0'];
    ...
    Hgt=load('trueHomog_synth_data.txt');
    t1=zeros(3,1);
    R1=eye(3,3);
...
if(type=='f')
    ...
    [Hgt, corrs, I1, I2 ] = SIFTmatchpair([path fname1],[path fname2] );
    R1=eye(3);
    R2=eye(3);
    k1=eye(3);
    k2=eye(3);
